<div id="readme" class="Box-body readme blob js-code-block-container">
  <article class="markdown-body entry-content p-3 p-md-6" itemprop="text">
    ...
    <p>This project was developed at the <a href="https://nextlevelweek.com/" rel="nofollow">Next Level Week #3</a>, which is a complete application (backend, frontend and mobile). The goal is to connect people to orphanages that make children's day more special.</p>
